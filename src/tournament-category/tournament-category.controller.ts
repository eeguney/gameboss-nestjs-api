...
export class TournamentCategoryController {
    constructor(private tournamentCategoryService: TournamentCategoryService) {}
    ...
    createTournamentCategory(
        @Body() body: CreateTournamentCategoryDto,
    ): Promise<TournamentCategory> {
    ...
    updateTournamentCategoryWithId(
        ...
        return this.tournamentCategoryService.updateTournamentCategory(
            id,
            body,
        );
    }
